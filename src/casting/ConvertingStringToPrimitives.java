...
public class ConvertingStringToPrimitives {
    public static void main(String[] args) {
        ...
        int num1Int = Integer.parseInt(num1); // String is converted to int
        int num2Int = Integer.parseInt(num2); // returns primitive

        Integer num1Integer = Integer.valueOf(num1); // returns wrapper class
        Integer num2Integer = Integer.valueOf(num2); // String is converted into integer

        int num1IntValueOf = Integer.valueOf(num1); // String is converted into Integer and then int
