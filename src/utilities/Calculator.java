...
public class Calculator {
    ...
    1. A proper name
    2. Decide its accessibility (public)
    ...
    5. Does it take any argument
        ...
        NOTE: We can have multiple methods sharing the same name in the class only if they have different arguments.
    ...
    public static int divide(int num1, int num2){ // 15,2
        return num1 / num2;
    }
